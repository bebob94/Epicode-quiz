...
function onStarClick(event) {
  ...
  const starNumber = event.target.parentElement.classList[1].split("_")[1];
...
function inviaFeedback() {
  let feedback = document.getElementById("input").value;
  if (feedback !== "") {
